...
From Figure~\ref{fig:q3_eqe} (left panel), the broad plateau from 500--850 nm is highest for R1 and lowest for R2/R3 at most wavelengths, which increases the integrated area under R1's EQE curve. From the right panel (700+ nm only), R1 still remains above both R2 and R3 across most of the near-IR range; this directly explains why R1 retains the largest truncated $J_{sc}$ in Table~\ref{tab:q3_jsc}. The separation is most visible near 900 nm, where R1 exceeds R2 by about 8 percentage points in EQE.
...
Figure~\ref{fig:q3_sr} provides the same ranking as Figure~\ref{fig:q3_eqe}, which is expected from the SR-EQE conversion relation. In particular, the right panel shows R1 sustaining stronger responsivity from approximately 800 to 1050 nm, while R2 rolls off earlier. This earlier roll-off in R2 is consistent with weaker long-wavelength collection and therefore reduced tandem-relevant current.
...
Figure~\ref{fig:q3_reflectance} clarifies why R3 underperforms in full-spectrum current despite some competitive values near 700 nm: R3 is much more reflective in the blue band and also in the 900--1100 nm region. At 900 nm, R3 reflectance (6.22\%) is almost double R1 (3.30\%), reducing optical coupling into the absorber and lowering the near-IR EQE/SR response.
